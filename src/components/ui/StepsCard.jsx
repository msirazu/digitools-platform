  ...
  return (
    <div className="w-11/12 lg:w-10/12 mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        <div className="border border-gray-200 rounded-xl p-10 bg-white relative hover:border-gray-300 hover:shadow-xl hover:cursor-pointer transition duration-300">
            ...
            <div className="flex flex-col justify-center items-center gap-5">
                ...
                <FaRegUser className="text-3xl text-one"/>
                </div>
        ...
        <div className="border border-gray-200 rounded-xl p-10 bg-white relative hover:border-gray-300 hover:shadow-xl hover:cursor-pointer transition duration-300">
            ...
            <div className="flex flex-col justify-center items-center gap-5">
                <div className="bg-gray-200 w-15 h-15 flex justify-center items-center rounded-full">
                <FaBox className="text-3xl text-one"/>
                </div>
        ...
        <div className="border border-gray-200 rounded-xl p-10 bg-white relative hover:border-gray-300 hover:shadow-xl hover:cursor-pointer transition duration-300">
            ...
            <div className="flex flex-col justify-center items-center gap-5">
                <div className="bg-gray-200 w-15 h-15 flex justify-center items-center rounded-full">
                <FaRocket className="text-3xl text-one"/>
                </div>
