  ...
  return (
    <div className="w-11/12 lg:w-10/12 mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        <div className="card bg-base-100 shadow-sm hover:shadow-xl hover:cursor-pointer transition duration-300">
        ...
        <div className="card gradient-one shadow-sm text-white hover:shadow-xl hover:cursor-pointer transition duration-300">
          <div className="card-body relative">
            <span className="badge badge-s badge-warning mx-auto absolute -top-2 left-1/2 -translate-x-1/2">Most Popular</span>
